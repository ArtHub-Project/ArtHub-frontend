        ...
        <div className="flex w-full space-x-8 ">
          ...
          <div className=" h-auto space-y-8">
            ...
            <div className="p-6 bg-white rounded-2xl shadow">
              <div className="mb-8">
                <h3 className="text-2xl text-black font-bold mb-2">Contact Information</h3>
                <hr className="opacity-20 border border-zinc-400" />
              </div>
              <div className="form-control w-full mb-4">
                <label className="label">
                  <span className="label-text text-black text-sm font-bold ">Email Address</span>
                </label>
                <input
                  type="text"
              ...
              <div className="form-control w-full">
                <label className="label">
                  <span className="label-text text-black text-sm font-bold ">Telephone</span>
                </label>
                <input
                  type="text"
            ...
            <div className="p-6 bg-white rounded-2xl shadow">
              <div className="mb-8">
                <h3 className="text-2xl text-black font-bold mb-2">Promo / Coupon code</h3>
                <hr className="opacity-20 border border-zinc-400" />
              </div>
              <div className="form-control w-full mb-4 flex flex-row space-x-8 items-end">
                <div className="w-3/4">
                  <label className="label">
                    <span className="label-text text-black text-sm font-bold ">Coupon</span>
                  </label>
                  <input
                    type="text"
              ...
              <h4 className="text-lg text-black font-bold">Description</h4>
            ...
            <div className="p-6 bg-white rounded-2xl shadow">
              <div className="mb-8">
                <h3 className="text-2xl text-black font-bold mb-2">Delivery Option</h3>
                <hr className="opacity-20 border border-zinc-400" />
              </div>
                  ...
                  <div className="w-full rbg-slate-50 rounded-lg border p-5 bg-[#FAF9FE] text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-[#d946ef] peer-checked:ring-[#d946ef] peer-checked:ring-offset-2">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center justify-between">
                        <p className="text-m font-bold uppercase text-black">Free Shipping</p>
                        <div>
                      ...
                      <div className="text-sm flex items-end justify-between">
                        <p>
                          7 - 14 Business Days based on Weight & Destination [Free Shipping will apply at final step]
                        </p>
                ...
                <label className="cursor-pointer">
                  ...
                  <div className="w-full rbg-slate-50 rounded-lg border p-5 bg-[#FAF9FE] text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-[#d946ef] peer-checked:ring-[#d946ef] peer-checked:ring-offset-2">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-sm flex items-end justify-between">
                        <p>
                          1 - 2 Business Days based on Weight & Destination [Free Shipping will apply at final step]{' '}
                        </p>
            ...
            <div className="p-6 bg-white rounded-2xl shadow">
              <div className="mb-8">
                <h3 className="text-2xl text-black font-bold mb-2">Shipping Address</h3>
                <hr className="opacity-20 border border-zinc-400" />
              </div>
              <div className="form-control w-full mb-4 flex flex-row space-x-8 items-end">
                <div className="w-2/4">
            ...
            <div className="p-6 bg-white rounded-2xl shadow">
              <div className="mb-4">
                <h3 className="text-2xl text-black font-bold mb-2">Payment methods</h3>
                <hr className="opacity-20 border border-zinc-400" />
              </div>
